/**
 * Contrôleur Stimulus pour gérer les collections de formulaires
 * from: Grafikart
 */
...
export default class extends Controller {
  ...
  addElement = (e) => {
    ...
    window.scrollTo(element.offsetLeft, element.offsetTop - 100)
  }
  ...
  addDeleteButton = (item) => {
    ...
    btn.setAttribute('class', 'text-destructive hover:text-destructive/80 underline text-sm font-semibold cursor-pointer w-full mt-2')
